class UserController {
  ...
  onEdit() {
    ...
    this.formUpdateEl.addEventListener('submit', async e => {
      e.preventDefault();
      ...
      let photo = await this.getPhoto(this.formUpdateEl);
  ...
  onSubmit() {
    this.formEl.addEventListener('submit', async (event) => {
      ...
      values.photo = await this.getPhoto(this.formEl);
  ...
  getPhoto(formEl) {
    return new Promise((resolve, reject) => {
      ...
      return file ? fileReader.readAsDataURL(file) : resolve('dist/img/boxed-bg.jpg');
    });
  }
